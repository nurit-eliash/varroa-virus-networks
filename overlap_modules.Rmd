...
# Aim: to find genes appear in matching modules of the 66 and 57 libraries.
...
1. does the overlaping genes share genes with the old-hubgenes?
2. to which module the silenced genes, and specifically the silenced genes, belong to?
```{r}
...
## (1) virus > module (virus tpm > module eigengene). 
### Quantifying module–trait associations, for the 66 libraries
```{r from the chunk of WGCNA 3.a Quantifying module–trait associations, eval=F, echo=T}
...
### Quantifying module–trait associations, for the 57 libraries
```{r, eval=F, echo=T}
