...
silenced_overlap.57
```
* Non of the 11 silenced-genes belong to the Magenta module (8 belong to purple module, 2 to pink and 1 to green). 
...
for that, we need to know (1) the prediction of the network analysis for the virus-module interaction, (2) the connectivity of each gene to their module, and (3) the specific virus-gene interaction.  
