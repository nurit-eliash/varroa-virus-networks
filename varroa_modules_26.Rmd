---
title: "varroa_modules for 26 studies"
author: "Nurit"
date: "4/13/2020"
...
---
this analysis is on 26 libraries from 7 different studies
...
grid.arrange(p1,p2,p3,p4,p5,p6,p7,nrow = 2, ncol = 3)
...
pMag_VDV4 <- ggplot(dat,aes(x = MEmagenta, y = log(VDV4+0.01))) +
  geom_point() + 
...
pRed_VDV4 <- ggplot(dat,aes(x = MEred, y = log(VDV4+0.01))) +
  geom_point() + 
...
pVDV2_VDV4 <- ggplot(dat,aes(x = VDV2, y = log(VDV4+0.01))) +
  geom_point() + 
...
pVDV2_VDV4
grid.arrange(pMag_VDV2, pMag_VDV4,pRed_VDV4 ,pRed_VDV2, nrow = 2, ncol = 2)
