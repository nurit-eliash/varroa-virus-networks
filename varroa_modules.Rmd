...
verboseScatterplot(x = corModulTrait_66, y = virusAbundCor_66, main = "Viral abundance predicts varroa-virus interaction", xlab = "Varroa-virus interaction", ylab = "Virus abundance")
```
