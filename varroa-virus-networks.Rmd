...
virusId <- read_tsv("data/viruses_old.txt", col_names = c("target_id", "description"))
...
```{r sft plot,fig.cap = "Figure S2a.  Network construction using 10,247 genes of 66 SRA varroa libraries.  Picking soft threshold.", message=FALSE, warning=FALSE,fig.show="hold", out.width="50%"}
# Plot the results:
sft_df <- data.frame(
...
```
##### Module 10
```{r GO-terms module number 10, message=FALSE, warning=FALSE}
...
```
##### Module 14
```{r GO-terms module number 14, message=FALSE, warning=FALSE}
