...
setwd("~/OneDrive - OIST/Repos/varroa-virus-networks")
...
autoplotly(ggplot(PCi,aes(x=PC1,y=PC2,col=Collection_method), dynamicTicks = TRUE, tooltip = "all")+
   ...
   scale_color_manual(values = c("#FF1BB3","#A7FF5B","#99554D", "#1AB2FF", "#1827FF"))+ #your colors here
   theme_classic()+
     ggtitle("PCA of libraries based on eigengenes in different Collection method"))
...
#dont run - i need to figure out how to change the Hover Text for each dot, so it will show the name of the specific library
----------
